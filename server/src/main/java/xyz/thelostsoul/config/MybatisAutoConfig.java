...
@AutoConfigureAfter({MybatisAutoConfiguration.class, MybatisPluginConfig.class})
...
public class MybatisAutoConfig {
    ...
    public MybatisAutoConfig(MybatisProperties properties,
    ...
    public SqlSessionFactory sqlSessionFactory(@Qualifier("multiDataSource") DataSource dataSource) throws Exception {
        ...
        factory.setTransactionFactory(new MultipleDataSourceTransactionFactory());
